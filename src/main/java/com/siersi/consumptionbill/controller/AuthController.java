...
public class AuthController {
     ...
     */
    @PostMapping("/login")
    public Result<TokenVo> login(@RequestBody @Valid LoginRequest loginRequest) throws InterruptedException {
        ...
        TokenVo tokens = jwtUtil.generateTokensWithForceLogout(loginRequest.getAccount());
     ...
     */
    @PostMapping("/refresh")
    public Result<TokenVo> refresh(@RequestBody Map<String, String> request) {
        String refreshToken = request.get("refreshToken");
        TokenVo newTokens = jwtUtil.refreshToken(refreshToken);
